...
public class SqlBackgroundExecutionApi {
    ...
    public String fetchQueryResultParquet(String executionId, String sortBy, String filter, String select, String groupBy) throws ApiException {
        ApiResponse<String> localVarResp = fetchQueryResultParquetWithHttpInfo(executionId, sortBy, filter, select, groupBy);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> fetchQueryResultParquetWithHttpInfo(String executionId, String sortBy, String filter, String select, String groupBy) throws ApiException {
     ...
     */
    public okhttp3.Call fetchQueryResultParquetAsync(String executionId, String sortBy, String filter, String select, String groupBy, final ApiCallback<String> _callback) throws ApiException {
