...
public class SqlExecutionApi {
    ...
    /**
     * [EXPERIMENTAL] GetByQueryCsv: Executes Sql, returned in CSV format, where the sql is simply in the url. (asynchronously)
     *  For simple single-line query execution via the url. e.g. &#x60;select ^ from Sys.Field order by 1, 2&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param query HoneycombSql to Execute (must be one line only) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
    ...
    /**
     * [EXPERIMENTAL] GetByQueryExcel: Executes Sql, returned in Excel (xlsx) format (as a file to be downloaded) format, where the sql is simply in the url. (asynchronously)
     *  For simple single-line query execution via the url. e.g. &#x60;select ^ from Sys.Field order by 1, 2&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param query HoneycombSql to Execute (must be one line only) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param timeout In seconds: &lt;0 → ∞, 0 → 120s (optional, default to 0)
    ...
    /**
     * [EXPERIMENTAL] GetByQueryJson: Executes Sql, returned in JSON format, where the sql is simply in the url. (asynchronously)
     *  For simple single-line query execution via the url. e.g. &#x60;select ^ from Sys.Field order by 1, 2&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param query HoneycombSql to Execute (must be one line only) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param timeout In seconds: &lt;0 → ∞, 0 → 120s (optional, default to 0)
    ...
    /**
     * [EXPERIMENTAL] GetByQueryPipe: Executes Sql, returned in pipe-delimited format, where the sql is simply in the url. (asynchronously)
     *  For simple single-line query execution via the url. e.g. &#x60;select ^ from Sys.Field order by 1, 2&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param query HoneycombSql to Execute (must be one line only) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
    ...
    /**
     * [EXPERIMENTAL] GetByQuerySqlite: Executes Sql, returned in SqLite DB (sqlite3) format (as a file to be downloaded) format, where the sql is simply in the url. (asynchronously)
     *  For simple single-line query execution via the url. e.g. &#x60;select ^ from Sys.Field order by 1, 2&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param query HoneycombSql to Execute (must be one line only) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param timeout In seconds: &lt;0 → ∞, 0 → 120s (optional, default to 0)
    ...
    /**
     * [EXPERIMENTAL] PutByQueryCsv: Executes Sql, returned in CSV format, where the sql is the post-body url. (asynchronously)
     *  For more complex HoneycombSql a PUT will allow for longer Sql. e.g.: &#x60;&#x60;&#x60;sql @@cutoff &#x3D; select #2020-02-01#; @issues &#x3D; select Id, SortId, Summary, Created, Updated from Dev.Jira.Issue where Project&#x3D;&#39;HC&#39; and Created &lt; @@cutoff and Updated &gt; @@cutoff;  select i.Id, i.SortId, i.Summary, LinkText, LinkedIssueId, LinkedIssueSortId, LinkedIssueSummary from @issues i inner join Dev.Jira.Issue.Link li     on i.Id &#x3D; li.IssueId &#x60;&#x60;&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param body HoneycombSql to Execute (may be multi-line) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
    ...
    /**
     * [EXPERIMENTAL] PutByQueryExcel: Executes Sql, returned in Excel (xlsx) format (as a file to be downloaded), where the sql is the post-body url. (asynchronously)
     *  For more complex HoneycombSql a PUT will allow for longer Sql. e.g.: &#x60;&#x60;&#x60;sql @@cutoff &#x3D; select #2020-02-01#; @issues &#x3D; select Id, SortId, Summary, Created, Updated from Dev.Jira.Issue where Project&#x3D;&#39;HC&#39; and Created &lt; @@cutoff and Updated &gt; @@cutoff;  select i.Id, i.SortId, i.Summary, LinkText, LinkedIssueId, LinkedIssueSortId, LinkedIssueSummary from @issues i inner join Dev.Jira.Issue.Link li     on i.Id &#x3D; li.IssueId &#x60;&#x60;&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param body HoneycombSql to Execute (may be multi-line) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param timeoutSeconds In seconds: &lt;0 → ∞, 0 → 120s (optional, default to 0)
    ...
    /**
     * [EXPERIMENTAL] PutByQueryJson: Executes Sql, returned in JSON format, where the sql is the post-body url. (asynchronously)
     *  For more complex HoneycombSql a PUT will allow for longer Sql. e.g.: &#x60;&#x60;&#x60;sql @@cutoff &#x3D; select #2020-02-01#; @issues &#x3D; select Id, SortId, Summary, Created, Updated from Dev.Jira.Issue where Project&#x3D;&#39;HC&#39; and Created &lt; @@cutoff and Updated &gt; @@cutoff;  select i.Id, i.SortId, i.Summary, LinkText, LinkedIssueId, LinkedIssueSortId, LinkedIssueSummary from @issues i inner join Dev.Jira.Issue.Link li     on i.Id &#x3D; li.IssueId &#x60;&#x60;&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param body HoneycombSql to Execute (may be multi-line) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param timeoutSeconds In seconds: &lt;0 → ∞, 0 → 120s (optional, default to 0)
    ...
    /**
     * [EXPERIMENTAL] PutByQueryPipe: Executes Sql, returned in pipe-delimited format, where the sql is the post-body url. (asynchronously)
     *  For more complex HoneycombSql a PUT will allow for longer Sql. e.g.: &#x60;&#x60;&#x60;sql @@cutoff &#x3D; select #2020-02-01#; @issues &#x3D; select Id, SortId, Summary, Created, Updated from Dev.Jira.Issue where Project&#x3D;&#39;HC&#39; and Created &lt; @@cutoff and Updated &gt; @@cutoff;  select i.Id, i.SortId, i.Summary, LinkText, LinkedIssueId, LinkedIssueSortId, LinkedIssueSummary from @issues i inner join Dev.Jira.Issue.Link li     on i.Id &#x3D; li.IssueId &#x60;&#x60;&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param body HoneycombSql to Execute (may be multi-line) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
    ...
    /**
     * [EXPERIMENTAL] PutByQuerySqlite: Executes Sql, returned in SqLite DB (sqlite3) format (as a file to be downloaded), where the sql is the post-body url. (asynchronously)
     *  For more complex HoneycombSql a PUT will allow for longer Sql. e.g.: &#x60;&#x60;&#x60;sql @@cutoff &#x3D; select #2020-02-01#; @issues &#x3D; select Id, SortId, Summary, Created, Updated from Dev.Jira.Issue where Project&#x3D;&#39;HC&#39; and Created &lt; @@cutoff and Updated &gt; @@cutoff;  select i.Id, i.SortId, i.Summary, LinkText, LinkedIssueId, LinkedIssueSortId, LinkedIssueSummary from @issues i inner join Dev.Jira.Issue.Link li     on i.Id &#x3D; li.IssueId &#x60;&#x60;&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param body HoneycombSql to Execute (may be multi-line) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param timeoutSeconds In seconds: &lt;0 → ∞, 0 → 120s (optional, default to 0)
    ...
    /**
     * [EXPERIMENTAL] PutQueryToFormat: Executes Sql, returned in JSON format, where the sql is the post-body url. (asynchronously)
     *  This formats SQL (given a set of options as to how to do so). It takes some SQL (or a fragment thereof, it need not fully parse as yet and certainly need not execute correctly) and returns the reformatted version. e.g. &#x60;&#x60;&#x60;sql select x,y,z from a inner join b on a.x&#x3D;b.x where x&gt;y or y!&#x3D;z &#x60;&#x60;&#x60; becomes &#x60;&#x60;&#x60;sql select x, y, z from a inner join b    on a.x &#x3D; b.x where x &gt; y    or y !&#x3D; z &#x60;&#x60;&#x60; 
     * @param body HoneycombSql to Pretty-Print. Even if it doesn&#39;t parse an attempt will be made to format it (required)
     * @param trailingCommas Should commas be after an expression (as opposed to before) (optional, default to true)
     * @param uppercaseKeywords Should key words be capitalized (optional, default to false)
