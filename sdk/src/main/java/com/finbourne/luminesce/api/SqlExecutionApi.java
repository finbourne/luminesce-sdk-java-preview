...
public class SqlExecutionApi {
     ...
     */
    public okhttp3.Call getByQueryCsvCall(String query, String queryName, Boolean download, Integer timeout, String delimiter, String escape, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("X-LUSID-SDK-Version", "1.13.213");
    ...
    private okhttp3.Call getByQueryCsvValidateBeforeCall(String query, String queryName, Boolean download, Integer timeout, String delimiter, String escape, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getByQueryCsvCall(query, queryName, download, timeout, delimiter, escape, _callback);
        return localVarCall;
     ...
     */
    public String getByQueryCsv(String query, String queryName, Boolean download, Integer timeout, String delimiter, String escape) throws ApiException {
     ...
     */
    public ApiResponse<String> getByQueryCsvWithHttpInfo(String query, String queryName, Boolean download, Integer timeout, String delimiter, String escape) throws ApiException {
     ...
     */
    public okhttp3.Call getByQueryCsvAsync(String query, String queryName, Boolean download, Integer timeout, String delimiter, String escape, final ApiCallback<String> _callback) throws ApiException {
     ...
     */
    public File getByQueryExcel(String query, String queryName, Integer timeout) throws ApiException {
     ...
     */
    public ApiResponse<File> getByQueryExcelWithHttpInfo(String query, String queryName, Integer timeout) throws ApiException {
     ...
     */
    public okhttp3.Call getByQueryExcelAsync(String query, String queryName, Integer timeout, final ApiCallback<File> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getByQueryParquetCall(String query, String queryName, Integer timeout, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call getByQueryParquetValidateBeforeCall(String query, String queryName, Integer timeout, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getByQueryParquetCall(query, queryName, timeout, _callback);
        return localVarCall;
     ...
     */
    public File getByQueryParquet(String query, String queryName, Integer timeout) throws ApiException {
     ...
     */
    public ApiResponse<File> getByQueryParquetWithHttpInfo(String query, String queryName, Integer timeout) throws ApiException {
    ...
    /**
     * GetByQueryParquet: Executes Sql, returned in Parquet (.parquet) format (as a file to be downloaded) format, where the sql is simply in the url. (asynchronously)
     *  For simple single-line query execution via the url. e.g. &#x60;select ^ from Sys.Field order by 1, 2&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param query LuminesceSql to Execute (must be one line only) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param timeout In seconds: &lt;0 → ∞, 0 → 120s (optional, default to 0)
     ...
     */
    public okhttp3.Call getByQueryParquetAsync(String query, String queryName, Integer timeout, final ApiCallback<File> _callback) throws ApiException {
     ...
     */
    public File getByQuerySqlite(String query, String queryName, Integer timeout) throws ApiException {
     ...
     */
    public ApiResponse<File> getByQuerySqliteWithHttpInfo(String query, String queryName, Integer timeout) throws ApiException {
     ...
     */
    public okhttp3.Call getByQuerySqliteAsync(String query, String queryName, Integer timeout, final ApiCallback<File> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getByQueryXmlCall(String query, String queryName, Boolean download, Integer timeout, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call getByQueryXmlValidateBeforeCall(String query, String queryName, Boolean download, Integer timeout, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getByQueryXmlCall(query, queryName, download, timeout, _callback);
        return localVarCall;
     ...
     */
    public String getByQueryXml(String query, String queryName, Boolean download, Integer timeout) throws ApiException {
     ...
     */
    public ApiResponse<String> getByQueryXmlWithHttpInfo(String query, String queryName, Boolean download, Integer timeout) throws ApiException {
    ...
    /**
     * GetByQueryXml: Executes Sql, returned in Xml format, where the sql is simply in the url. (asynchronously)
     *  For simple single-line query execution via the url. e.g. &#x60;select ^ from Sys.Field order by 1, 2&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param query LuminesceSql to Execute (must be one line only) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
     ...
     */
    public okhttp3.Call getByQueryXmlAsync(String query, String queryName, Boolean download, Integer timeout, final ApiCallback<String> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call putByQueryCsvCall(String body, String queryName, Boolean download, Integer timeoutSeconds, String delimiter, String escape, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call putByQueryCsvValidateBeforeCall(String body, String queryName, Boolean download, Integer timeoutSeconds, String delimiter, String escape, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = putByQueryCsvCall(body, queryName, download, timeoutSeconds, delimiter, escape, _callback);
        return localVarCall;
     ...
     */
    public String putByQueryCsv(String body, String queryName, Boolean download, Integer timeoutSeconds, String delimiter, String escape) throws ApiException {
     ...
     */
    public ApiResponse<String> putByQueryCsvWithHttpInfo(String body, String queryName, Boolean download, Integer timeoutSeconds, String delimiter, String escape) throws ApiException {
     ...
     */
    public okhttp3.Call putByQueryCsvAsync(String body, String queryName, Boolean download, Integer timeoutSeconds, String delimiter, String escape, final ApiCallback<String> _callback) throws ApiException {
     ...
     */
    public File putByQueryExcel(String body, String queryName, Integer timeoutSeconds) throws ApiException {
     ...
     */
    public ApiResponse<File> putByQueryExcelWithHttpInfo(String body, String queryName, Integer timeoutSeconds) throws ApiException {
     ...
     */
    public okhttp3.Call putByQueryExcelAsync(String body, String queryName, Integer timeoutSeconds, final ApiCallback<File> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call putByQueryParquetCall(String body, String queryName, Integer timeoutSeconds, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    private okhttp3.Call putByQueryParquetValidateBeforeCall(String body, String queryName, Integer timeoutSeconds, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = putByQueryParquetCall(body, queryName, timeoutSeconds, _callback);
        return localVarCall;
     ...
     */
    public File putByQueryParquet(String body, String queryName, Integer timeoutSeconds) throws ApiException {
     ...
     */
    public ApiResponse<File> putByQueryParquetWithHttpInfo(String body, String queryName, Integer timeoutSeconds) throws ApiException {
    ...
    /**
     * PutByQueryParquet: Executes Sql, returned in Parquet format, where the sql is the post-body url. (asynchronously)
     *  For more complex LuminesceSql a PUT will allow for longer Sql. e.g.: &#x60;&#x60;&#x60;sql @@cutoff &#x3D; select #2020-02-01#; @issues &#x3D; select Id, SortId, Summary, Created, Updated from Dev.Jira.Issue where Project&#x3D;&#39;HC&#39; and Created &lt; @@cutoff and Updated &gt; @@cutoff;  select i.Id, i.SortId, i.Summary, LinkText, LinkedIssueId, LinkedIssueSortId, LinkedIssueSummary from @issues i inner join Dev.Jira.Issue.Link li     on i.Id &#x3D; li.IssueId &#x60;&#x60;&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param body LuminesceSql to Execute (may be multi-line) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param timeoutSeconds In seconds: &lt;0 → ∞, 0 → 120s (optional, default to 0)
     ...
     */
    public okhttp3.Call putByQueryParquetAsync(String body, String queryName, Integer timeoutSeconds, final ApiCallback<File> _callback) throws ApiException {
     ...
     */
    public File putByQuerySqlite(String body, String queryName, Integer timeoutSeconds) throws ApiException {
     ...
     */
    public ApiResponse<File> putByQuerySqliteWithHttpInfo(String body, String queryName, Integer timeoutSeconds) throws ApiException {
     ...
     */
    public okhttp3.Call putByQuerySqliteAsync(String body, String queryName, Integer timeoutSeconds, final ApiCallback<File> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call putByQueryXmlCall(String body, String queryName, Boolean download, Integer timeoutSeconds, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    private okhttp3.Call putByQueryXmlValidateBeforeCall(String body, String queryName, Boolean download, Integer timeoutSeconds, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = putByQueryXmlCall(body, queryName, download, timeoutSeconds, _callback);
        return localVarCall;
     ...
     */
    public String putByQueryXml(String body, String queryName, Boolean download, Integer timeoutSeconds) throws ApiException {
     ...
     */
    public ApiResponse<String> putByQueryXmlWithHttpInfo(String body, String queryName, Boolean download, Integer timeoutSeconds) throws ApiException {
    ...
    /**
     * PutByQueryXml: Executes Sql, returned in Xml format, where the sql is the post-body url. (asynchronously)
     *  For more complex LuminesceSql a PUT will allow for longer Sql. e.g.: &#x60;&#x60;&#x60;sql @@cutoff &#x3D; select #2020-02-01#; @issues &#x3D; select Id, SortId, Summary, Created, Updated from Dev.Jira.Issue where Project&#x3D;&#39;HC&#39; and Created &lt; @@cutoff and Updated &gt; @@cutoff;  select i.Id, i.SortId, i.Summary, LinkText, LinkedIssueId, LinkedIssueSortId, LinkedIssueSummary from @issues i inner join Dev.Jira.Issue.Link li     on i.Id &#x3D; li.IssueId &#x60;&#x60;&#x60;  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - something failed with the execution or parsing of your query - 401 Unauthorized 
     * @param body LuminesceSql to Execute (may be multi-line) (required)
     * @param queryName Name to apply to the query in logs and &#x60;Sys.Logs.HcQueryStart&#x60; (optional)
     * @param download Makes this a file-download request (as opposed to returning the data in the response-body) (optional, default to false)
     ...
     */
    public okhttp3.Call putByQueryXmlAsync(String body, String queryName, Boolean download, Integer timeoutSeconds, final ApiCallback<String> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call putQueryDesignToSqlCall(QueryDesign queryDesign, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call putQueryDesignToSqlValidateBeforeCall(QueryDesign queryDesign, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = putQueryDesignToSqlCall(queryDesign, _callback);
        return localVarCall;
     ...
     */
    public String putQueryDesignToSql(QueryDesign queryDesign) throws ApiException {
     ...
     */
    public ApiResponse<String> putQueryDesignToSqlWithHttpInfo(QueryDesign queryDesign) throws ApiException {
     ...
     */
    public okhttp3.Call putQueryDesignToSqlAsync(QueryDesign queryDesign, final ApiCallback<String> _callback) throws ApiException {
     ...
     */
    public String putSqlToQueryDesign(String body, Boolean validateWithMetadata) throws ApiException {
     ...
     */
    public ApiResponse<String> putSqlToQueryDesignWithHttpInfo(String body, Boolean validateWithMetadata) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] PutSqlToQueryDesign: Generates a SQL-design object from SQL string, if possible. (asynchronously)
     * SQL to attempt to create a Design object from
     * @param body SQL query to generate the design object from (required)
     * @param validateWithMetadata Should the table be validated against the users&#39; view of Sys.Field to fill in DataTypes, etc.? (optional, default to true)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call putSqlToQueryDesignAsync(String body, Boolean validateWithMetadata, final ApiCallback<String> _callback) throws ApiException {
