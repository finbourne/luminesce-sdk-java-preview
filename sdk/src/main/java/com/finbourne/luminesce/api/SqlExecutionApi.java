...
public class SqlExecutionApi {
     ...
     */
    public String getByQueryParquet(String query, String queryName, Integer timeout) throws ApiException {
        ApiResponse<String> localVarResp = getByQueryParquetWithHttpInfo(query, queryName, timeout);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> getByQueryParquetWithHttpInfo(String query, String queryName, Integer timeout) throws ApiException {
     ...
     */
    public okhttp3.Call getByQueryParquetAsync(String query, String queryName, Integer timeout, final ApiCallback<String> _callback) throws ApiException {
     ...
     */
    public String putByQueryParquet(String body, String queryName, Integer timeoutSeconds) throws ApiException {
        ApiResponse<String> localVarResp = putByQueryParquetWithHttpInfo(body, queryName, timeoutSeconds);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<String> putByQueryParquetWithHttpInfo(String body, String queryName, Integer timeoutSeconds) throws ApiException {
     ...
     */
    public okhttp3.Call putByQueryParquetAsync(String body, String queryName, Integer timeoutSeconds, final ApiCallback<String> _callback) throws ApiException {
