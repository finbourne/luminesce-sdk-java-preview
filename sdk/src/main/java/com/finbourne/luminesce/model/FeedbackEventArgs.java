  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FeedbackEventArgs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FeedbackEventArgs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("propertyValues") != null && !jsonObj.get("propertyValues").isJsonArray()) {
